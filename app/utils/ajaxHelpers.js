...
const helpers = {
  ...
  findUser: function(user){
    return axios.post('https://immense-thicket-47816.herokuapp.com/users/find', user);
  },

  //adding user
  addUser: function(user){
    return axios.post('https://immense-thicket-47816.herokuapp.com/users/new', user);
  },

  //find loggedIn user
  findLoggedInUser: function(){
    return axios.get('https://immense-thicket-47816.herokuapp.com/loggedin');
  },

  //find current user's playlist
  findCurrentPlaylist: function(){
    return axios.get('https://immense-thicket-47816.herokuapp.com/playlist');
  },

  //add song to user playlist
  addSongToPlaylist: function(song){
      return axios.post('https://immense-thicket-47816.herokuapp.com/songs/new', song);
  },
  ...
  deleteSong: function(mongoID) {
    ...
    return axios.delete('https://immense-thicket-47816.herokuapp.com/songs/' + mongoID)
  },
